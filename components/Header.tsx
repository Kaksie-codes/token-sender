...
export default function Header() {
  return (
    <header className="w-full flex items-center justify-between px-4 py-3 border-b border-gray-200 bg-white dark:bg-gray-900">
      <div className="flex items-center gap-2">
        <span className="text-xl font-bold tracking-tight">Token Sender</span>
      </div>
      <div className="flex items-center gap-3">
        <a
          href="https://github.com/Kaksie-codes/token-sender"
          target="_blank"
        ...
        >
          {/* GitHub SVG icon */}
          <svg height="28" width="28" viewBox="0 0 16 16" fill="currentColor" className="text-gray-800 dark:text-gray-100">
